...
const FilterByPrice = ({setPriceFilter, handleFiltersClose}) => {
  ...
  return (
    <article className='filterprice grid-container'>
        ...
        <form className='filterprice__from grid-container' onSubmit={handleSubmit(submit)}>
            <label className='filterprice__form-field grid-container'>
                <span className='filterprice__form-label'>From</span>
                <input className='filterprice__form-input' {...register('from')}  min={0} type="number" />
            </label>
            <label className='filterprice__form-field grid-container'>
                <span className='filterprice__form-label'>To</span>
                <input className='filterprice__form-input' {...register('to')} min={0} type="number" />
            </label>
